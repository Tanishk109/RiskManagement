...
export default function FraudPulse() {
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${mobileOpen ? "open" : ""}`}>
      ...
      <nav aria-label="MerchantShield modules"><span className="nav-label">Workspace</span><a className="suite-nav-link" href="/"><BarChart3 size={17} /><span>Overview</span></a><span className="nav-label nav-label-spaced">Fraud Risk</span><a className="suite-nav-link" href="/"><Gauge size={17} /><span>Risk Check</span></a><a className="suite-nav-link" href="/"><TableProperties size={17} /><span>Transactions</span></a><a className="suite-nav-link" href="/"><ListChecks size={17} /><span>Review Queue</span></a><a className="suite-nav-link" href="/"><SlidersHorizontal size={17} /><span>Cost Lab</span></a><span className="nav-label nav-label-spaced">Loss prevention</span><a className="suite-nav-link" href="/chargebacks"><FileText size={17} /><span>Chargebacks</span></a><a className="suite-nav-link active" href="/fraud-pulse"><Activity size={17} /><span>Fraud Pulse</span></a><a className="suite-nav-link" href="/abuse-rings"><Network size={17} /><span>Abuse Rings</span></a></nav>
      <div className="sidebar-note"><LockKeyhole size={16} /><div><strong>Held-out rows excluded</strong><span>Pulse replay uses chronological validation probabilities only.</span></div></div>
    </aside>
