  ...
  return <div className="app-shell">
    <aside className={`sidebar ${mobileOpen ? "open" : ""}`}>
      ...
      <nav aria-label="MerchantShield modules">
        ...
        <span className="nav-label nav-label-spaced">Loss prevention</span><a className="suite-nav-link active" href="/chargebacks"><FileText size={17} /><span>Chargebacks</span></a>
      </nav>
